...
<p align="center">
  Search, compare, and install 5,315+ command-line tools with structured YAML/JSON output.
</p>
<p align="center">
...
Search performance: **~3ms per query** on the full 5,315+ tool index (with cached BM25 engine).

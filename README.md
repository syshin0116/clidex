...
<p align="center">
  Search, compare, and install 5,312+ command-line tools with structured YAML/JSON output.
</p>
<p align="center">
...
Search performance: **~3ms per query** on the full 5,312+ tool index (with cached BM25 engine).

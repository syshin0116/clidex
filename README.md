...
<p align="center">
  Search, compare, and install 5,333+ command-line tools with structured YAML/JSON output.
</p>
<p align="center">
...
Search performance: **~3ms per query** on the full 5,333+ tool index (with cached BM25 engine).

...
<p align="center">
  Search, compare, and install 5,279+ command-line tools with structured YAML/JSON output.
</p>
<p align="center">
...
Search performance: **~3ms per query** on the full 5,279+ tool index (with cached BM25 engine).
